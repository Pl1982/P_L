<!-- Faire un formulaire d’inscription à un site de rencontre pour animaux :

- L’utilisateur choisit un pseudonyme créatif et aguicheur
- Il renseigne une adresse email valide :
    - Fonction de vérification
- Il choisit un mot de passe sécurisé
- Il choisit le ou les profils attendus.
    - Par exemple : chat, chien, cochon d’inde, poule
    - Une sélection multiple
- Il choisit le type de relation attendue
    - Trouver sa moitié
    - Prendre un verre
    - Friendzone
    - Coup d’un soir
- Une case à cocher pour accepter les conditions d’utilisation
- Le bouton pour valider ne s’affiche que si :
    - Tous les champs sont remplis
    - La case des conditions d’utilisation est cochée
- Au clic sur le bouton de validation (quand il s’affiche), console.log de toutes les informations sélectionnées précedemment -->
<template>
    <form @submit.prevent="submit">
        ...
        <div class="form-input">
            ...
            <p v-if="password !== '' && !passwordHasMinEightCharacters" class="form-error">
                Le mot de passe doit contenir 8 caractères
            </p>
            <p v-if="password !== '' && !passwordContainsOneNumber" class="form-error">
                Le mot de passe doit contenir au moins un nombre
            </p>
            <p v-if="password !== '' && !passwordContainsOneCapitalLetter" class="form-error">
                Le mot de passe doit contenir au moins une majuscule
            </p>
            <p v-if="password !== '' && !passwordContainsOneSpecialCharacter" class="form-error">
        ...
        <div class="form-input">
            ...
            <div v-for="profile in availableProfiles">
                <input type="radio" :name="profile" :id="'user' + profile" :value="profile" v-model="userProfile" />
        ...
        <div class="form-input">
            <p>Je cherche</p>
            <div v-for="profile in availableProfiles">
                <input type="checkbox" :name="profile" :id="'search' + profile" :value="profile"
